            ...
            for i in range(n_lstm_layers):
                if projection_dim < lstm_dim:
                    ...
                    lstm_cell = tf.nn.rnn_cell.LSTMCell(
                        lstm_dim, num_proj=projection_dim,   #这里设置projection后的维度，官方lstm隐藏层state是4096维，projection是512维，我们设置的隐藏层维度不变，projection维度为100
                ...
                with tf.control_dependencies([layer_output]):
                    ...
                    for i in range(2):
                        new_state = tf.concat(     #应该是在这个地方做了一个concat操作使得最后的projection维度乘以2
