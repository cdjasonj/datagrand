...
def compute_f1(dev_data,dev_pred):
    ...
    save_result(dev_pred,dev_data,'result_for_f1_elmo_localatt_gru')
    p,r,f = evaluate_conll_file('result_for_f1_elmo_localatt_gru')
...
def fit(params,elmo_dim,train_data,dev_data,test_data,cv_num,char_word2vec,char_glove,char_fasttext,bichar_word2vec,bichar_glove,bichar_fastext):
    ...
    bilstm = Local_att_gru(char_word2vec,char_glove,char_fasttext,bichar_word2vec,bichar_glove,bichar_fastext,elmo_dim,params)
